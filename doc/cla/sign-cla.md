...
In order for your contribution to Thrive Bureau ERP to be accepted, you have to sign the
Thrive Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [thrive/thrive](https://github.com/thrive/thrive), adding a new file
...
3. An Thrive R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [thrive/thrive](/thrive/thrive), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is Thrive, the file would be
    `doc/cla/corporate/thrive.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Thrive Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `thrivebureau.com`.  In that case someone from the Thrive team will
make the pull request on your behalf.

* Printable Thrive CCLA v1.0 https://www.thrivebureau.com/files/legal/Thrive-CCLA-v1.0.pdf
* Printable Thrive ICLA v1.0 https://www.thrivebureau.com/files/legal/Thrive-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Thrive is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Thrive project

* protect the Thrive project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Thrive project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Thrive project under specific
...
The Thrive CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Thrive Bureau ERP to use, modify and
...
(ICLA) of Thrive.  The agreement is executed by adding your name and
...
removed from the Thrive project.
