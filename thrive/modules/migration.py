...
VERSION_RE = re.compile(
    r"""^
        # Optional prefix with Thrive version
        ((
            6\.1|
        ...
        # After Thrive version we allow precisely 2 or 3 parts
    ...
    def migrate_module(self, pkg, stage):
        ...
        def compare(version):
            ...
            if majorless_version:
                # We should not re-execute major-less scripts when upgrading to new Thrive version
