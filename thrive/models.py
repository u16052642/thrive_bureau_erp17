...
class BaseModel(metaclass=MetaModel):
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    def _compute_display_name(self):
        ...
        it can be made field-dependent using :attr:`~thrive.api.depends` and
        context-dependent using :attr:`~thrive.api.depends_context`.
        """
        if self._rec_name:
    ...
    def _read_group_fill_temporal(self, data, groupby, annoted_aggregates,
        ...
        if fill_from:
            fill_from = thrive.fields.Datetime.to_datetime(fill_from) if isinstance(fill_from, datetime.datetime) else thrive.fields.Date.to_date(fill_from)
        ...
        if fill_to:
            fill_to = thrive.fields.Datetime.to_datetime(fill_to) if isinstance(fill_to, datetime.datetime) else thrive.fields.Date.to_date(fill_to)
