...
HTTP methods). See
https://www.thrivebureau.com/documentation/master/developer/reference/addons/http.html#csrf
for more details.
...
class GeoIP(collections.abc.Mapping):
    ...
    .. note:
        ...
        :attr:`~thrive.http.request.geoip`.

    .. code-block:

        >>> GeoIP('127.0.0.1').country.iso_code
        >>> thrive_ip = socket.gethostbyname('thrivebureau.com')
        >>> GeoIP(thrive_ip).country.iso_code
        'FR'
    """
