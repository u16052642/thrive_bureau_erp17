...
function getPivotCellValueAndFormat(pivotId, pivotCell) {
    if (!pivotCell.domain) {
        ...
        const fn = pivotCell.isHeader ? THRIVE_PIVOT_HEADER : THRIVE_PIVOT;
...
functionRegistry
    ...
    .add("THRIVE.PIVOT", THRIVE_PIVOT)
    .add("THRIVE.PIVOT.HEADER", THRIVE_PIVOT_HEADER)
    .add("THRIVE.PIVOT.POSITION", THRIVE_PIVOT_POSITION)
    .add("THRIVE.PIVOT.TABLE", THRIVE_PIVOT_TABLE);
