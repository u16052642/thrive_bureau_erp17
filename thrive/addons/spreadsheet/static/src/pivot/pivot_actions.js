 ...
 * pivot domain args.
 * e.g. =THRIVE.PIVOT("1", "measure", "country_id", 1) matches a filter on
 * country_id.
 *
 * @returns {boolean}
 */
export function SET_FILTER_MATCHING_CONDITION(position, env) {
    ...
    return (
        ...
        (pivotFunction === "THRIVE.PIVOT" ||
            pivotFunction === "THRIVE.PIVOT.HEADER" ||
            pivotFunction === "THRIVE.PIVOT.TABLE") &&
