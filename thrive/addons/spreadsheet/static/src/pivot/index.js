...
invalidateEvaluationCommands.add("RENAME_THRIVE_PIVOT");

invalidateDependenciesCommands.add("UPDATE_THRIVE_PIVOT_DOMAIN");
invalidateDependenciesCommands.add("REMOVE_PIVOT");
invalidateDependenciesCommands.add("INSERT_PIVOT");
invalidateDependenciesCommands.add("RENAME_THRIVE_PIVOT");

invalidateCFEvaluationCommands.add("UPDATE_THRIVE_PIVOT_DOMAIN");
invalidateCFEvaluationCommands.add("REMOVE_PIVOT");
invalidateCFEvaluationCommands.add("INSERT_PIVOT");
invalidateCFEvaluationCommands.add("RENAME_THRIVE_PIVOT");
