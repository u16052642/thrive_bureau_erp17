...
class HrEmployee(models.Model):
    ...
    l10n_au_previous_id_bms = fields.Char(string="Previous BMS ID")
    ...
    l10n_au_tax_free_threshold = fields.Boolean(string="Tax-free Threshold")
    l10n_au_super_account_ids = fields.One2many(
        "l10n_au.super.account", "employee_id", string="Super Accounts")
    l10n_au_super_account_id = fields.Many2one("l10n_au.super.account", string="Super Account")
    ...
    l10n_au_child_support_garnishee_amount = fields.Float(string="Child Support Garnishee Amount")
