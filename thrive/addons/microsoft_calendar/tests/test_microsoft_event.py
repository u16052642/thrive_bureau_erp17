...
class TestMicrosoftEvent(TestCommon):
    ...
    def test_performance_check(self):
        ...
        # Other tests take care of how we update thrive records with the api result.
        ...
        mapped = events._load_thrive_ids_from_db(self.env)
        self.assertFalse(mapped, "No thrive record should correspond to the microsoft values")
        ...
        mapped = recurrences._load_thrive_ids_from_db(self.env)
        self.assertFalse(mapped, "No thrive record should correspond to the microsoft values")
