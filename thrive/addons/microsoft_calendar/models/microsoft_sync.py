...
class MicrosoftSync(models.AbstractModel):
    ...
    def _sync_recurrence_microsoft2thrive(self, microsoft_events, new_events=None):
        ...
        for recurrent_master in recurrent_masters:
            ...
            new_recurrence_thrive = self.env['calendar.recurrence'].with_context(dont_notify=True).create(new_calendar_recurrence)
    ...
    def _update_microsoft_recurrence(self, recurrence, events):
        ...
        for e in events_to_update:
            ...
            if event_values:
                ...
                thrive_event.with_context(dont_notify=True).write(dict(event_values, need_sync_m=False))
        ...
        for mevent in (existing - cancelled).filter(lambda e: e.lastModifiedDateTime):
            ...
            if thrive_event:
                ...
                if ms_event_updated_time >= thrive_event_updated_time:
                    ...
                    thrive_event.with_context(dont_notify=True)._write_from_microsoft(mevent, vals)
