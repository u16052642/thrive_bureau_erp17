...
class SaleOrder(models.Model):
    ...
    def _test_demo_generate_subscriptions(self):
        ...
        with patch('thrive.addons.sale_subscription.models.sale_order.SaleOrder._process_invoices_to_send',
             ...
             patch('thrive.addons.sale_subscription.models.sale_order.SaleOrder._subscription_commit_cursor',
                  wraps=_do_nothing),\
             patch('thrive.addons.sale_subscription.models.sale_order.SaleOrder._subscription_rollback_cursor',
                  wraps=_do_nothing):
