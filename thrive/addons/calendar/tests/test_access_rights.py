...
class TestAccessRights(TransactionCase):
    ...
    def test_meeting_edit_access_notification_handle_in_thrive(self):
        # set notifications to "handle in Thrive" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in Thrive" notification setting can
