...
from thrive.addons.l10n_ec_edi.models.account_tax import L10N_EC_TAXSUPPORTS
from thrive.addons.l10n_ec_edi.models.account_move import L10N_EC_WTH_FOREIGN_GENERAL_REGIME_CODES
from thrive.addons.l10n_ec_edi.models.account_move import L10N_EC_WTH_FOREIGN_TAX_HAVEN_OR_LOWER_TAX_CODES
from thrive.addons.l10n_ec_edi.models.account_move import L10N_EC_WTH_FOREIGN_SUBJECT_WITHHOLD_CODES
from thrive.addons.l10n_ec_edi.models.account_move import L10N_EC_WTH_FOREIGN_DOUBLE_TAXATION_CODES
from thrive.addons.l10n_ec_edi.models.account_move import L10N_EC_WITHHOLD_FOREIGN_REGIME
            ...
            if line.invoice_id:
                ...
                if amount_base and line.tax_id:
                    ...
                    if previous_related_lines:
                        # Thrive onchanges creates a new object to replace line with it, following line removes the new object (last element in the list)
