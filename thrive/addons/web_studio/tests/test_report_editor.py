...
from thrive.addons.base.models.ir_actions_report import IrActionsReport
from thrive.addons.web_studio.controllers.main import WebStudioController
from thrive.addons.web_studio.controllers.report import WebStudioReportController, get_report_view_copy
from thrive.addons.web.controllers.report import ReportController
from thrive.http import _request_stack, route
from thrive.tests.common import HttpCase, TransactionCase
from thrive.tests import tagged
from thrive.tools import DotDict, mute_logger
...
class TestReportEditorUIUnit(HttpCase):
    ...
    def test_basic_report_edition(self):
        ...
        self.assertXMLEqual(self.main_view_document.arch, """
            <t t-name="web_studio.test_report_document" class="">
               ...
               <p>edited with thrive editor 2</p>
             </t>
        """)
    ...
    def test_table_rendering(self):
        ...
        self.assertXMLEqual(self.main_view_document.arch, """
            <t t-name="web_studio.test_report_document" class="">
               <p>p edited with thriveEditor</p>
               <table class="valid_table">
                 <tbody>
                   <tr>
                     <td>I am valid</td>
               ...
               <table class="invalid_table">
                 <t t-foreach="doc.child_ids" t-as="child">
                   <tr>
                     <td>edited with thriveEditor</td>
                   </tr>
                 </t>
               </table>
             </t>
    ...
    def test_field_placeholder(self):
        ...
        self.assertXMLEqual(self.main_view.arch, """
            <t t-name="web_studio.test_report">
               <t t-call="web.html_container">
                 <div class="">
                   <p><br/>edited with thriveEditor</p>
                 </div>
                 <t t-foreach="docs" t-as="doc">
                   <t t-call="web_studio.test_report_document"/>
                 </t>
