...
class TestHttpBase(HttpCase):
    ...
    def setUpClass(cls):
        ...
        cls.classPatch(thrive.http.Application, 'session_store', session_store)
        cls.classPatch(thrive.http.Application, 'geoip_city_db', geoip_resolver)
        cls.classPatch(thrive.http.Application, 'geoip_country_db', geoip_resolver)
