...
from thrive.addons.whatsapp.tests.common import MockOutgoingWhatsApp, MockIncomingWhatsApp
...
class TestWAPerformance(BaseMailPerformance, MockOutgoingWhatsApp, MockIncomingWhatsApp):
    ...
    def test_composer_mono(self):
        ...
        with self.mockWhatsappGateway(), self.assertQueryCount(employee=31):
