...
class TestAccountConsolidationJournal(AccountConsolidationTestCase):
    ...
    @patch(
        'thrive.addons.account_consolidation.models.consolidation_period.ConsolidationPeriodComposition._get_journal_lines_values')
    @patch(
        'thrive.addons.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod._get_journal_lines_values')
