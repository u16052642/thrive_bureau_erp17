...
from thrive.tests import tagged, JsonRpcException
...
from thrive.addons.sale.controllers.portal import PaymentPortal
...
class TestSalePayment(AccountPaymentCommon, SaleCommon, PaymentHttpCommon):
    ...
    def test_invoice_is_final(self):
        ...
        with mute_logger('thrive.addons.sale.models.payment_transaction'), patch(
            'thrive.addons.sale.models.sale_order.SaleOrder._create_invoices',
    ...
    def test_check_payment_access_token_before_rerouting_flow(self):
        ...
        ), patch('thrive.addons.payment.utils.check_access_token') as check_payment_access_token_mock:
            try:
                payment_portal_controller._get_extra_payment_form_values(
                    sale_order_id=self.sale_order.id, access_token='whatever'
                )
    ...
    def test_transaction_route_rejects_unexpected_kwarg(self):
        ...
        with self.assertRaises(JsonRpcException, msg='thrive.exceptions.ValidationError'):
