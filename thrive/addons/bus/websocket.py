...
from thrive.http import root, Request, Response, SessionExpiredException, get_default_session
...
class Websocket:
    ...
    def __init__(self, sock, session):
        ...
        self._selector = (
            ...
            if thrive.evented and hasattr(selectors, 'PollSelector')
...
class WebsocketConnectionHandler:
    ...
    def _handle_public_configuration(cls, request):
        if not os.getenv('THRIVE_BUS_PUBLIC_SAMESITE_WS'):
            return
