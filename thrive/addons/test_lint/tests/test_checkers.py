...
from . import _thrive_checker_sql_injection
...
class TestSqlLint(TransactionCase):
    ...
    def test_sql_injection_detection(self):
        ...
        checker = _thrive_checker_sql_injection.ThriveBaseChecker(self.linter)

        node = _thrive_checker_sql_injection.astroid.extract_node("""
        def test(): 
            arg = "test"
            arg = arg + arg
