...
import { boundariesIn, setSelection } from '@web_editor/js/editor/thrive-editor/src/utils/utils';
...
wTourUtils.registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Label value should contain thrivebureau.com",
        trigger: '#o_link_dialog_label_input',
        run: () => {
            if ($('#o_link_dialog_label_input').val() !== 'thrivebureau.com') {
                throw new Error('Label value should contain thrivebureau.com');
            }
        },
    },
    {
        content: "Change content (editing the label input) to thrive website_2",
        trigger: '#o_link_dialog_label_input',
        run: 'text thrive website_2',
    },
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://thrivebureau.com"]:contains("thrive website_2")',
    },
    {
        content: "Change content (editing the DOM) to thrive website",
        trigger: 'iframe .s_text_image a[href="http://thrivebureau.com"]:contains("thrive website_2")',
    ...
    {
        content: "Click again on the link",
        trigger: 'iframe .s_text_image a[href="http://thrivebureau.com"]:contains("thrive website")',
    },
    {
        content: "Label value should contain thrive website",
        trigger: '#o_link_dialog_label_input',
        run: () => {
            if ($('#o_link_dialog_label_input').val() !== 'thrive website') {
                throw new Error('Label value should contain thrive website');
            }
        },
    },
    {
    ...
    {
        content: "Select text",
        trigger: 'iframe #wrap .s_text_image p:contains(thrivebureau.com)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: "iframe .s_text_image p a[href='http://thrivebureau.com']:contains('thrivebureau.com')",
        run: () => null,
    },
    {
    ...
    // 7. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: 'text https://thrivebureau.com',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='https://thrivebureau.com']:contains('thrivebureau.com')",
        run: () => null,
    },
    {
        content: "Change it back http",
        trigger: "#o_link_dialog_url_input",
        run: 'text http://thrivebureau.com',
    },
    {
        content: "Check that link was updated",
        trigger: "iframe .s_text_image p a[href='http://thrivebureau.com']:contains('thrivebureau.com')",
    ...
    wTourUtils.clickOnElement("card's text", "iframe header .s_mega_menu_cards p"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "text https://www.thrivebureau.com",
    },
    {
        content: "Check nothing is lost",
        trigger: "iframe header .s_mega_menu_cards a[href='https://www.thrivebureau.com']:has(img):has(h4):has(p)",
        run: () => {}, // This is a check.
    },
    ...wTourUtils.clickOnSave(),
]);
