...
import { UNMERGEABLE_SELECTORS } from "@web_editor/js/editor/thrive-editor/src/utils/sanitize";
 ...
 */
Text.prototype.oEnterThriveEditor = Text.prototype.oEnter;
Text.prototype.oEnter = function (offset) {
    ...
    this.oEnterThriveEditor(...arguments);
};
 ...
 */
HTMLElement.prototype.oDeleteBackwardThriveEditor = HTMLElement.prototype.oDeleteBackward;
HTMLElement.prototype.oDeleteBackward = function (offset, alreadyMoved = false, offsetLimit) {
    ...
    this.oDeleteBackwardThriveEditor(...arguments);
};
