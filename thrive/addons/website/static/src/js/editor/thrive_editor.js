...
/**
 * The goal of this patch is to correctly handle ThriveEditor's behaviour for text
 * highlight elements.
 */
patch(ThriveEditor.prototype, {
    /**
     * @override
     */
    _onClipboardCopy(e) {
        ...
        if (firstChild && firstChild.className && firstChild.className.includes("o_text_highlight_item")) {
            ...
            e.clipboardData.setData("text/thrive-editor", html);
        }
    },
    /**
     * @override
