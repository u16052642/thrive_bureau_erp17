...
from thrive.tools import html2plaintext, cleanup_xml_node, find_xml_value
...
class AccountEdiXmlUBL20(models.AbstractModel):
    ...
    def _get_invoice_payment_terms_vals_list(self, invoice):
        ...
        if payment_term:
            # The payment term's note is automatically embedded in a <p> tag in Thrive
    ...
    def _export_invoice_vals(self, invoice):
        ...
        # Fixed taxes are not supposed to be taxes in real live. However, this is the way in Thrive to manage recupel
