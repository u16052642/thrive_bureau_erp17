...
DEFAULT_IAP_ENDPOINT = 'https://l10n-pe-edi.api.thrivebureau.com'
DEFAULT_IAP_TEST_ENDPOINT = 'https://l10n-pe-edi.test.thrivebureau.com'
    ...
    def _l10n_pe_edi_get_cdr_error_messages(self):
        ...
        return {
            ...
            '154': _lt("Your RUC is not linked to Digiflow as OSE, please make sure you have follow this process in the SUNAT portal:\n"
                       ...
                       "Reference: \n"
                       "https://www.thrivebureau.com/documentation/17.0/applications/finance/accounting/fiscal_localizations/localizations/peru.html#what-do-you-need-to-do"),
        ...
        if res.get('error') and res.get('code') in ['1033', '4000']:
            ...
            if res_retrieve_cdr.get('error'):
                ...
                if is_same_document_id and is_same_ruc:
                    ...
                    # Thrive hit an exception and rolled back the transaction after sending.
