...
{
    "name": "VoIP",
    "summary": """Make and receive phone calls from within Thrive.""",
    "description": """Adds a softphone and helpers to make phone calls directly from within your Thrive database.""",
