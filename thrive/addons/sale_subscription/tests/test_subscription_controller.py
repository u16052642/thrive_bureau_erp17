...
class TestSubscriptionController(PaymentHttpCommon, PaymentCommon, TestSubscriptionCommon):
    ...
    def test_automatic_invoice_token(self):
        ...
        with patch('thrive.addons.sale_subscription.models.sale_order.SaleOrder._do_payment', wraps=self._mock_subscription_do_payment),\
            patch('thrive.addons.sale_subscription.models.sale_order.SaleOrder._send_success_mail', wraps=self._mock_subscription_send_success_mail):
    ...
    def test_portal_partial_payment(self):
        with patch('thrive.addons.sale_subscription.models.sale_order.SaleOrder._do_payment',
                   wraps=self._mock_subscription_do_payment), \
                patch('thrive.addons.sale_subscription.models.sale_order.SaleOrder._send_success_mail',
