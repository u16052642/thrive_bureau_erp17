...
from thrive.addons.mail.models.mail_mail import _UNFOLLOW_REGEX
...
from thrive.tools import mute_logger, email_normalize, parse_contact_from_email
...
class UnfollowFromEmailTest(MailCommon, HttpCase):
    ...
    @mute_logger('thrive.addons.base.models', 'thrive.addons.mail.controllers.mail', 'thrive.http', 'thrive.models')
    ...
    @mute_logger('thrive.addons.mail.controllers.mail', 'thrive.models', 'thrive.http')
