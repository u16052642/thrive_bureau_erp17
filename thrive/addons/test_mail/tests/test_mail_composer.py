...
from thrive.addons.mail.wizard.mail_compose_message import MailComposer
...
from thrive.tools import email_normalize, mute_logger, formataddr
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('thrive.models.unlink', 'thrive.addons.mail.models.mail_mail', 'thrive.addons.mail.models.mail_message_schedule')
                        ...
                        self.assertMailMail(
                            ...
                            email_values={
                                'headers': {
                                    ...
                                    'X-Thrive-Objects': f'{record._name}-{record.id}',
                                },
