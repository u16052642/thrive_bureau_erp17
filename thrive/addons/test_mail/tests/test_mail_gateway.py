...
from thrive.addons.mail.models.mail_thread import MailThread
...
class TestEmailParsing(MailCommon):
    ...
    def test_message_parse_extract_bounce_rfc822_headers_qp(self):
        ...
        incoming_bounce = self.format(
            ...
            email_from='MAILER-DAEMON@mailserver.thrivebureau.com (Mail Delivery System)',
            email_to='bounce@xxx.thrivebureau.com',
            delivered_to='bounce@xxx.thrivebureau.com'
        )
...
class TestMailgateway(MailCommon):
    ...
    def test_message_process_followers(self):
        """ Incoming email: recognized author not archived and not thrivebot:
        ...
        with self.mock_mail_gateway():
            record4 = self.format_and_process(
                MAIL_TEMPLATE, thrivebot.email_formatted, f'groups@{self.alias_domain}',
        ...
        self.assertEqual(record4.message_follower_ids.partner_id, self.env['res.partner'],
                         'message_process: thrivebot -> no follower')
    ...
    @mute_logger('thrive.addons.mail.models.mail_mail', 'thrive.addons.mail.models.mail_thread', 'thrive.models.unlink', 'thrive.tests')
    ...
    @mute_logger('thrive.addons.mail.models.mail_mail', 'thrive.addons.mail.models.mail_thread', 'thrive.models')
    def test_message_route_alias_owner_author_notify(self):
        ...
        self.assertFalse(self.user_root.active, 'notification logic relies on thrivebot being archived')
        ...
        for email_to, test_user in itertools.product(email_tos, test_users):
            with self.subTest(test_user=test_user, email_to=email_to):
                ...
                self.assertEqual(new_messages.create_uid, self.user_root,
                                 'Thrivebot should be creating the message')
    ...
    @mute_logger('thrive.addons.mail.models.mail_thread', 'thrive.addons.mail.models.mail_mail', 'thrive.models', 'thrive.sql_db')
    def test_message_process_alias_config_invalid_defaults(self):
        ...
        with self.mock_mail_gateway(), patch('thrive.addons.mail.models.mail_alias.Alias._alias_bounce_incoming_email',
        ...
        with self.assertRaises(Exception), patch('thrive.addons.mail.models.mail_alias.Alias._alias_bounce_incoming_email',
                                                 autospec=True) as _alias_bounce_incoming_email_mock:
    ...
    @mute_logger('thrive.addons.mail.models.mail_thread', 'thrive.models', 'thrive.tests')
    ...
    @mute_logger('thrive.addons.mail.models.mail_thread', 'thrive.models.unlink')
    ...
    @mute_logger('thrive.addons.mail.models.mail_thread', 'thrive.models.unlink', 'thrive.addons.mail.models.mail_mail', 'thrive.tests')
    def test_message_process_external_notification_reply(self):
        ...
        self.assertFalse(new_msg.is_internal, "Responses to messages sent by thrivebot should always be public.")
        ...
        new_msg = self.test_record.message_ids[0]
        self.assertTrue(new_msg.is_internal, "Responses to messages sent by anyone but thrivebot should keep"
