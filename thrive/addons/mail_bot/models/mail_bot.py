    ...
    def _get_answer(self, record, body, values, command=False):
        ...
        if self._is_bot_in_private_channel(record):
            ...
            if thrivebot_state == 'onboarding_emoji' and self._body_contains_emoji(body):
                ...
                return Markup(_("Great! 👍<br/>To access special commands, <b>start your sentence with</b> <span class=\"o_thrivebot_command\">/</span>. Try getting help."))
            elif thrivebot_state == 'onboarding_command' and command == 'help':
                self.env.user.thrivebot_state = "onboarding_ping"
                self.env.user.thrivebot_failed = False
                return Markup(_("Wow you are a natural!<br/>Ping someone with @username to grab their attention. <b>Try to ping me using</b> <span class=\"o_thrivebot_command\">@ThriveBot</span> in a sentence."))
                ...
                self.env.user.thrivebot_failed = False
                return Markup(_("I am a simple bot, but if that's a dog, he is the cutest 😊 <br/>Congratulations, you finished this tour. You can now <b>close this chat window</b>. Enjoy discovering Thrive."))
            ...
            # help message
                ...
                if thrivebot_state == 'onboarding_emoji':
                    ...
                    return Markup(_("Not exactly. To continue the tour, send an emoji: <b>type</b> <span class=\"o_thrivebot_command\">:)</span> and press enter."))
                    ...
                    self.env.user.thrivebot_failed = True
                    return Markup(_("Not sure what you are doing. Please, type <span class=\"o_thrivebot_command\">/</span> and wait for the propositions. Select <span class=\"o_thrivebot_command\">help</span> and press enter"))
                elif thrivebot_state == 'onboarding_ping':
                    self.env.user.thrivebot_failed = True
                    return Markup(_("Sorry, I am not listening. To get someone's attention, <b>ping him</b>. Write <span class=\"o_thrivebot_command\">@ThriveBot</span> and select me."))
                return random.choice([
                    Markup(_("I'm not smart enough to answer your question.<br/>To follow my guide, ask: <span class=\"o_thrivebot_command\">start the tour</span>.")),
                    _("Hmmm..."),
                    _("I'm afraid I don't understand. Sorry!"),
                    Markup(_("Sorry I'm sleepy. Or not! Maybe I'm just trying to hide my unawareness of human language...<br/>I can show you features if you write: <span class=\"o_thrivebot_command\">start the tour</span>."))
                ])
        return False
