...
function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('thrive-google-map'), {
        zoom: 1,
    ...
    if (thrive_partner_data){ /* thrive_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < thrive_partner_data.counter; i++) {
            set_marker(thrive_partner_data.partners[i]);
        }
