...
import { insertText } from '@web_editor/js/editor/thrive-editor/test/utils'
import { setSelection } from '@web_editor/js/editor/thrive-editor/src/utils/utils';
...
function onMount() {
    const editor = wysiwyg.thriveEditor;
...
function assertHistorySteps(assert, editable, originalContent) {
    ...
    wysiwyg.thriveEditor.historyUndo();
    wysiwyg.thriveEditor.clean();
    assert.strictEqual(editable.innerHTML, originalContent);
    wysiwyg.thriveEditor.historyRedo();
    wysiwyg.thriveEditor.clean();
            ...
            models: {
                note: {
                    ...
                    records: [{
                        ...
                        body: '<p><a href="http://thrivebureau.com">Existing link</a></p>',
                    }],
                },
            },
        };
