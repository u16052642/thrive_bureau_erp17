...
class WebsiteHrRecruitment(http.Controller):
    ...
    def jobs_compatibility(self, country=None, department=None, office_id=None, contract_type_id=None, **kwargs):
        """
        Deprecated since Thrive 16.3: those routes are kept by compatibility.
        They should not be used in Thrive code anymore.
        """
        warnings.warn(
            "This route is deprecated since Thrive 16.3: the jobs list is now available at /jobs or /jobs/page/XXX",
            DeprecationWarning
        )
        return self.jobs(
            country_id=country.id if country else None,
