    ...
    setup() {
        ...
        this.env.bus.addEventListener(
            ...
            ({ detail: { channel, message } }) => {
                ...
                if (channel.correspondent?.eq(this.store.thrivebot) && this.store.thrivebotOnboarding) {
                    // this cancels thrivebot onboarding auto-opening of chat window
                    this.store.thrivebotOnboarding = false;
                    return;
                }
