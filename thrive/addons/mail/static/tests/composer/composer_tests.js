...
QUnit.test("Show recipient list when there is more than 5 followers.", async () => {
    ...
    const partnerIds = pyEnv["res.partner"].create([
        { name: "test name 1", email: "test1@thrivebureau.com" },
        { name: "test name 2", email: "test2@thrivebureau.com" },
        { name: "test name 3", email: "test3@thrivebureau.com" },
        { name: "test name 4", email: "test4@thrivebureau.com" },
        { name: "test name 5", email: "test5@thrivebureau.com" },
        { name: "test name 6", email: "test6@thrivebureau.com" },
    ]);
    ...
    await contains("li", { text: "test1@thrivebureau.com" });
    await contains("li", { text: "test2@thrivebureau.com" });
    await contains("li", { text: "test3@thrivebureau.com" });
    await contains("li", { text: "test4@thrivebureau.com" });
    await contains("li", { text: "test5@thrivebureau.com" });
    await contains("li", { text: "test6@thrivebureau.com" });
