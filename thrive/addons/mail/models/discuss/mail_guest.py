...
import thrive
from thrive.tools import consteq, get_lang
...
class MailGuest(models.Model):
    ...
    def _init_messaging(self):
        self.ensure_one()
        # sudo: res.partner - exposing ThriveBot name and id
        thrivebot = self.env.ref('base.partner_root').sudo()
    ...
    def _guest_format(self, fields=None):
        ...
        for guest in self:
            ...
            if "write_date" in fields:
                data["write_date"] = thrive.fields.Datetime.to_string(guest.write_date)
            data['type'] = "guest"
