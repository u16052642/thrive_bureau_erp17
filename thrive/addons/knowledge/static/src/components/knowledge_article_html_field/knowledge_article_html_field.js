...
export class KnowledgeArticleHtmlField extends HtmlField {
    ...
    setup() {
        ...
        onWillUnmount(() => {
            if (this.wysiwyg?.thriveEditor) {
                this.wysiwyg.thriveEditor.removeEventListener("historyStep", this.editorStepsCallback);
                this.wysiwyg.thriveEditor.removeEventListener("onExternalHistorySteps", this.editorStepsCallback);
                this.wysiwyg.thriveEditor.removeEventListener("historyResetFromSteps", this.editorStepsCallback);
            }
        });
    }
    ...
    async startWysiwyg(wysiwyg) {
        ...
        this.wysiwyg.thriveEditor.addEventListener("historyStep", this.editorStepsCallback);
        this.wysiwyg.thriveEditor.addEventListener("onExternalHistorySteps", this.editorStepsCallback);
        this.wysiwyg.thriveEditor.addEventListener("historyResetFromSteps", this.editorStepsCallback);
    }
    ...
    async _lazyloadWysiwyg() {
        ...
        this.Wysiwyg = (await thrive.loader.modules.get('@knowledge/js/knowledge_wysiwyg')).KnowledgeWysiwyg;
    }
}
