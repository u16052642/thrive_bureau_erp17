...
export class AbstractBehavior extends Component {
    static props = {
        ...
        // ThriveEditor.editable, or the readonlyElementRef.el.
        root: { type: Element },
    ...
    setup() {
        ...
        if (!this.props.readonly) {
            onMounted(() => {
                ...
                // the rendering was done outside of the ThriveEditor,
     ...
     * attributes from a previous Thrive version, attributes from a drop/paste
    ...
    setupAnchor() {
        if (!this.props.readonly) {
            ...
            // prevent some interactions with ThriveEditor, @see web_editor module
    ...
    get editor () {
        return this.props.wysiwyg ? this.props.wysiwyg.thriveEditor : undefined;
    }
}
