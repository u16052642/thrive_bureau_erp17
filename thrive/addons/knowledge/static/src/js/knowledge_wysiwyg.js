...
import { isEmptyBlock } from "@web_editor/js/editor/thrive-editor/src/ThriveEditor";
 ...
 *
 * Note: The utils functions of the ThriveEditor are included in a different bundle
...
export class KnowledgeWysiwyg extends Wysiwyg {
    ...
    setup() {
        ...
        useBus(this.env.bus, 'KNOWLEDGE_WYSIWYG:HISTORY_STEP', () => this.thriveEditor.historyStep());
    ...
    async startEdition() {
        ...
        this.thriveEditor.options.renderingClasses = [...this.thriveEditor.options.renderingClasses, 'focused-comment'];
    }
