...
import { setSelection, boundariesIn } from "@web_editor/js/editor/thrive-editor/src/utils/utils";
...
export function appendArticleLink(htmlFieldContainerSelector, articleName, offset=0) {
    return [{ // open the command bar
        trigger: `${htmlFieldContainerSelector} .thrive-editor-editable > p:last-child`,
        run: function () {
