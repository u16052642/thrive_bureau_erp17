...
registry.category("web_tour.tours").add('knowledge_calendar_command_tour', {
    ...
    trigger: '.o_knowledge_editor .thrive-editor-editable h1',
    ...
    trigger: '.thrive-editor-editable',
    run: function () {
        this.$anchor.data('wysiwyg').thriveEditor.resetContent();
    },
}, {
    // Click on the "Create Item Calednar" helper
    trigger: '.o_knowledge_helper .o_knowledge_add_item_calendar',
    extra_trigger: '.thrive-editor-editable:not(:has(.o_knowledge_behavior_type_embedded_view))',
    run: 'click',
    ...
    trigger: '.o_knowledge_editor .thrive-editor-editable',
    run: 'click',
