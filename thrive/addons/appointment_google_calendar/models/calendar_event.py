...
class CalendarEvent(models.Model):
    ...
    def write(self, vals):
        # When the google_id is set on the Thrive event (which means the related Google Calendar event has been created),
        # sync the Thrive event to the Google calendar event to retrieve the Google Meet url.
