...
ENDPOINT = "https://l10n-fr-aspone.api.thrivebureau.com"
...
ERROR_CODE_TO_MSG = {
    ...
    'unknown_deposit': _lt("This deposit is unknown from Thrive Bureau ERP."),
    'unknown_declaration': _lt("This declaration is unknown from Thrive Bureau ERP."),
    ...
    'not_enterprise': _lt("You do not have an Thrive enterprise subscription."),
