...
from thrive.tools import format_amount, format_date, format_datetime, pdf
...
class IrActionsReport(models.Model):
    ...
    def _get_sol_form_fields_mapping(self, line):
        """ Dictionary mapping specific pdf fields name to Thrive Bureau ERP fields data for a sale order line.
        Override this method to add new fields to the mapping.

        :param recordset line: sale.order.line record
        :rtype: dict
        :return: mapping of fields name to Thrive Bureau ERP fields data
    ...
    def _get_so_form_fields_mapping(self, order):
        """ Dictionary mapping specific pdf fields name to Thrive Bureau ERP fields data for a sale order.
        Override this method to add new fields to the mapping.
