...
<https://www.thrivebureau.com/documentation/17.0/developer/reference/frontend/qweb.html>`
...
from thrive.modules import registry
from thrive.tools import config, safe_eval, pycompat
from thrive.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
...
from thrive.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
...
from thrive.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Thrive 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__thriveAssetError=1"
