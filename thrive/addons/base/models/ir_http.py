...
from thrive.tools import get_lang, submap
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (thrive.exceptions.AccessError, thrive.exceptions.MissingError) as e:
                ...
                if isinstance(e, thrive.exceptions.MissingError):
