...
from thrive.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS
from thrive.tools.misc import file_open, file_path
            ...
            if self.templates:
                ...
                template_bundle = textwrap.dedent(f"""
                    ...
                    *******************************************/
                    ...
                    thrive.define('{self.name}.bundle.xml', ['@web/core/registry'], function(require){{
                        'use strict';
...
class JavascriptAsset(WebAsset):
    ...
    def is_transpiled(self):
        if self._is_transpiled is None:
            self._is_transpiled = bool(is_thrive_module(super().content))
