...
from thrive.tests.case import TestCase
from thrive.tests.common import BaseCase, TransactionCase, users, warmup
from thrive.tests.result import ThriveTestResult
...
class TestRunnerLoggingCommon(TransactionCase):
    ...
    def _clean_message(self, message):
        root_path = PurePath(__file__).parents[4]  # removes /thrive/addons/base/tests/test_test_suite.py
