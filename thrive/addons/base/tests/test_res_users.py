...
from thrive.tests.common import Form, TransactionCase, new_test_user, tagged
...
class TestUsers(TransactionCase):
    ...
    @mute_logger('thrive.sql_db', 'thrive.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('thrive.addons.base.models.res_users.request', request)
