...
from thrive.tests import BaseCase, tagged
...
class TestRetryCommon(BaseCase):
    def get_tests_run_count(self):
        return int(os.environ.get('THRIVE_TEST_FAILURE_RETRIES', 0)) + 1
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when THRIVE_TEST_FAILURE_RETRIES is set"""
