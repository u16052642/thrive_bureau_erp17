...
import thrive
from thrive import api, fields
from thrive.tests.common import BaseCase, TransactionCase, RecordCapturer, get_db_name, tagged
...
class TestIrCronConcurrent(BaseCase, CronMixinCase):
    ...
    def setUp(self):
        ...
        with self.registry.cursor() as cr:
            env = api.Environment(cr, thrive.SUPERUSER_ID, {})
