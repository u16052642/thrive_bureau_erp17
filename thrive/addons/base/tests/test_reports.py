...
class TestReportsRenderingCommon(thrive.tests.HttpCase):
    ...
    def save_pdf(self):
        ...
        thrive.tests.save_test_file(self._testMethodName, self.last_pdf_content, 'pdf_', 'pdf', document_type='Report PDF', logger=_logger)
...
@thrive.tests.tagged('post_install', '-at_install', 'pdf_rendering')
...
@thrive.tests.tagged('post_install', '-at_install', '-standard', 'pdf_rendering')
