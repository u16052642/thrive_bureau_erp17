...
from thrive.addons.mail_group.tests.data import GROUP_TEMPLATE
...
class TestMailGroupMessage(TestMailListCommon):
    ...
    @mute_logger('thrive.addons.mail.models.mail_thread', 'thrive.addons.mail_group.models.mail_group_message')
