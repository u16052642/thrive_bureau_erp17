...
import { getAdjacentPreviousSiblings, isBlock, rgbToHex, commonParentGet } from '../editor/thrive-editor/src/utils/utils';
...
function fontToImg($editable) {
    const editable = $editable.get(0);
    const { fonts } = thrive.loader.modules.get("@web_editor/js/wysiwyg/fonts");
