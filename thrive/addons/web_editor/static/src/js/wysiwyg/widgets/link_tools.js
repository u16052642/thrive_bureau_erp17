...
export class LinkTools extends Link {
    ...
    applyLinkToDom() {
        ...
        this.props.wysiwyg.thriveEditor.historyStep();
    ...
    _onColorpaletteColorPicked(cssProperty, params) {
        ...
        this.props.wysiwyg.thriveEditor.execCommand('applyColor', '', 'color');
        this.props.wysiwyg.thriveEditor.execCommand('applyColor', '', 'backgroundColor');
    ...
    __onURLInput() {
        ...
        this.props.wysiwyg.thriveEditor.historyPauseSteps('_onURLInput');
        this._syncContent();
        this._adaptPreview();
        this.props.wysiwyg.thriveEditor.historyUnpauseSteps('_onURLInput');
    }
    /**
