...
import { deduceURLfromText } from "@web_editor/js/editor/thrive-editor/src/utils/sanitize";

const { getDeepRange, getInSelection, EMAIL_REGEX, PHONE_REGEX } = ThriveEditorLib;
