...
export class LinkPopoverWidget {
    static createFor(params) {
        ...
        params.wysiwyg?.thriveEditor.observerUnactive('LinkPopoverWidget');
        popoverWidget.start();
        params.wysiwyg?.thriveEditor.observerActive('LinkPopoverWidget');
    ...
    start() {
        ...
        .on('show.bs.popover.link_popover', () => {
            this.wysiwyg.thriveEditor.observerUnactive('show.bs.popover');
            this._loadAsyncLinkPreview();
            popoverShown = true;
        })
        .on('inserted.bs.popover', () => {
            this.wysiwyg.thriveEditor.observerActive('show.bs.popover');
        })
        .on('hide.bs.popover.link_popover', () => {
            this.wysiwyg.thriveEditor.observerUnactive('hide.bs.popover');
            popoverShown = false;
        })
        .on('hidden.bs.popover.link_popover', () => {
            this.wysiwyg.thriveEditor.observerActive('hide.bs.popover');
        ...
        if (document !== this.wysiwyg.thriveEditor.document) {
            $(this.wysiwyg.thriveEditor.document).on('mouseup.link_popover', onClickDocument);
        }
    ...
    destroy() {
        ...
        $(this.wysiwyg.thriveEditor.document).off('.link_popover');
