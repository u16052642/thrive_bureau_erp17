...
import { URL_REGEX } from '../../src/ThriveEditor.js';
import {
    BasicEditor,
    click,
    deleteBackward,
        ...
        describe('range collapsed', () => {
            ...
            it('should not change the url when the label change', async () => {
                ...
                await testEditor(BasicEditor, {
                    ...
                    stepFunction: async editor => {
                        await insertLineBreak(editor);
                        await insertText(editor, 'thrivebureau.com')
                    },
                    contentAfter: '<p>a<a href="https://google.com">google.com<br>thrivebureau.com[]</a></p>',
                });
            });
        });
        describe('range not collapsed', () => {
