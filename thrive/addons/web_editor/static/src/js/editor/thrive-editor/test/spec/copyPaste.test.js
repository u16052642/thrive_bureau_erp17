...
describe('Copy', () => {
    ...
    describe('range not collapsed', async () => {
        it('should copy a selection as text/plain, text/html and text/thrive-editor', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/thrive-editor')).to.be.equal('bcd');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/thrive-editor')).to.be.equal('abc<br>efg');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/thrive-editor')).to.be.equal('<table><tbody><tr><td><ul><li>a</li><li>b</li><li>c</li></ul></td><td><br></td></tr></tbody></table>');
                },
            });
        });
    });
...
describe('Cut', () => {
    ...
    describe('range not collapsed', async () => {
        it('should cut a selection as text/plain, text/html and text/thrive-editor', async () => {
            await testEditor(BasicEditor, {
                contentBefore: '<p>a[bcd]e</p>',
                stepFunction: async editor => {
                    const clipboardData = new DataTransfer();
        ...
        describe('range collapsed', async () => {
            ...
            it('should replace link for new content when pasting in an empty link', async () => {
                ...
                await testEditor(BasicEditor, {
                    contentBefore: '<p>xy<a href="#" oe-zws-empty-inline="">\u200B[]</a>z</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'http://thrivebureau.com');
                    },
                    contentAfter: '<p>xy<a href="http://thrivebureau.com">http://thrivebureau.com</a>[]z</p>',
                });
                const imageUrl = 'https://download.thrivecdn.com/icons/website/static/description/icon.png';
                await testEditor(BasicEditor, {
                    contentBefore: '<p>xy<a href="#" oe-zws-empty-inline="">\u200B[]</a>z</p>',
                    stepFunction: async editor => {
            ...
            it('should paste and transform plain text content over an empty link', async () => {
                await testEditor(BasicEditor, {
                    ...
                    stepFunction: async editor => {
                        await pasteText(editor, 'abc www.thrivebureau.com xyz');
                    },
                    contentAfter: '<p>abc <a href="http://www.thrivebureau.com">www.thrivebureau.com</a> xyz[]</p>',
                });
                await testEditor(BasicEditor, {
                    contentBefore: '<p><a href="#">[]\u200B</a></p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'thrivebureau.com\ngoogle.com');
                    },
                    contentAfter: '<p style="margin-bottom: 0px;"><a href="http://thrivebureau.com">thrivebureau.com</a></p>' +
            ...
            it('should paste html content over an empty link', async () => {
                await testEditor(BasicEditor, {
                    contentBefore: '<p><a href="#">[]\u200B</a></p>',
                    stepFunction: async editor => {
                        await pasteHtml(editor, '<a href="www.thrivebureau.com">thrivebureau.com</a><br><a href="www.google.com">google.com</a>');
                    },
                    contentAfter: '<p><a href="www.thrivebureau.com">thrivebureau.com</a><br><a href="www.google.com">google.com</a>[]</p>',
                });
            });
            it('should paste and transform URL among text', async () => {
                const url = 'https://www.thrivebureau.com';
                const imgUrl = 'https://download.thrivecdn.com/icons/website/static/description/icon.png';
        ...
        describe('range not collapsed', async () => {
            ...
            it('should restore selection when pasting plain text followed by UNDO', async () => {
                ...
                await testEditor(BasicEditor, {
                    contentBefore: '<p>[abc]</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'www.thrivebureau.com');
                        editor.historyUndo();
                    },
                    contentAfter: '<p>[abc]</p>',
                });
                await testEditor(BasicEditor, {
                    contentBefore: '<p>[abc]</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'def www.thrivebureau.com xyz');
                        editor.historyUndo();
                    },
                    contentAfter: '<p>[abc]</p>',
                });
            ...
            it('should paste and transform plain text content over a link if all of its contents is selected', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p><a href="http://www.thrivebureau.com">www.thrivebureau.com</a>[]</p>',
                });
                await testEditor(BasicEditor, {
                    contentBefore: '<p><a href="#">[xyz]</a></p>',
                    stepFunction: async editor => {
        ...
        describe('range collapsed', async () => {
            ...
            it('should paste and transform an image URL in a span', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p>a<span class="a">b<img src="https://download.thrivecdn.com/icons/website/static/description/icon.png">[]c</span>d</p>',
                });
            });
            ...
            it('should paste an image URL as a link in a p', async () => {
                const url = 'https://download.thrivecdn.com/icons/website/static/description/icon.png';
                await testEditor(BasicEditor, {
                    contentBefore: '<p>[]</p>',
                    stepFunction: async editor => {
