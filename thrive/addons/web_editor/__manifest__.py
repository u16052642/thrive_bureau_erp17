...
""",
    ...
    'assets': {
        ...
        'web.qunit_suite_tests': [
            ...
            'web_editor/static/src/js/editor/thrive-editor/test/utils.js'
        ],
        'web_editor.mocha_tests': [
            ...
            'web_editor/static/src/js/editor/thrive-editor/src/**/*js',
            'web_editor/static/src/js/editor/thrive-editor/test/spec/*js',
            'web_editor/static/src/js/editor/thrive-editor/test/*js',
        ],
    },
    'auto_install': True,
    'license': 'LGPL-3',
