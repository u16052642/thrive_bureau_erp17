...
from thrive.tools import float_repr, date_utils
from thrive.tools.xml_utils import cleanup_xml_node, find_xml_value
...
class AccountMove(models.Model):
    ...
    def _search_product_for_import(self, item_description):
        # Exported Thrive XML will have item_description = "[default_code] name".
