...
export class PaymentAdyen extends PaymentInterface {
    ...
    _handle_thrive_connection_failure(data = {}) {
        // handle timeout
        ...
        this._show_error(
            _t(
                "Could not connect to the Thrive server, please check your internet connection and try again."
            )
        );
    ...
    async handleAdyenStatusResponse() {
        ...
        if (!notification) {
            this._handle_thrive_connection_failure();
            return;
        }
