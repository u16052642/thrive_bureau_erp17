...
from thrive.addons.helpdesk.controllers.portal import CustomerPortal as HelpdeskCustomerPortal
from thrive.addons.account.controllers.portal import CustomerPortal as AccountCustomerPortal
