...
from thrive import models, fields, _, registry, api, SUPERUSER_ID
...
from thrive.tools import float_round, DEFAULT_SERVER_DATETIME_FORMAT, json_float_round

logger = logging.getLogger(__name__)

IAP_SERVICE_NAME = 'l10n_br_avatax_proxy'
DEFAULT_IAP_ENDPOINT = 'https://l10n-br-avatax.api.thrivebureau.com'
DEFAULT_IAP_TEST_ENDPOINT = 'https://l10n-br-avatax.test.thrivebureau.com'
