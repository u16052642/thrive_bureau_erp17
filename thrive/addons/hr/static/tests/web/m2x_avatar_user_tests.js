...
QUnit.module("M2XAvatarUser", ({ beforeEach }) => {
    ...
    QUnit.test("avatar card preview with hr", async (assert) => {
        ...
        const userId = pyEnv["res.users"].create({
            name: "Mario",
            email: "Mario@thrive.test",
            work_email: "Mario@thrive.pro",
            im_status: "online",
            phone: "+78786987",
        ...
        assert.deepEqual(getNodesTextContent(target.querySelectorAll(".o_card_user_infos > *")), ['Mario', 'sub manager', 'Managemment', 'Mario@thrive.pro', '+585555555']);
        // Close card
