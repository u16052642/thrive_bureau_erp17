...
{
    'name': 'Thrive WhatsApp Integration',
    'category': 'Hidden/Tools',
    'summary': 'Integrates Thrive with WhatsApp to use WhatsApp messaging service',
    'version': '1.0',
    'description': """This module integrates Thrive with WhatsApp to use WhatsApp messaging service""",
