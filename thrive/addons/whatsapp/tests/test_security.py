...
class WhatsAppControllerSecurity(MockIncomingWhatsApp, WhatsAppSecurityCase):
    ...
    @mute_logger('thrive.addons.whatsapp.controller.main')
...
class WhatsAppMessageSecurity(WhatsAppSecurityCase):
    ...
    def test_message_signup_token(self):
        ...
        # https://github.com/thrive/thrive/blob/554e6b0898727b6c08a9702e19ea8f2d67632c38/addons/auth_signup/controllers/main.py#L91
