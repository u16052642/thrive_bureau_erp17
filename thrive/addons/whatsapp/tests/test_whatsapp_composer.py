...
from thrive.addons.whatsapp.tests.common import WhatsAppCommon
...
Welcome to {{4}} office''',
                ...
                'variable_ids': [
                    ...
                    (0, 0, {'name': "{{4}}", 'line_type': "body", 'field_type': "free_text", 'demo_value': "Thrive In"}),
                ],
                'wa_account_id': cls.whatsapp_account.id,
            }
        ])
    ...
    def test_composer_tpl_button_url(self):
        self._add_button_to_template(self.template_basic, name="test url", website_url='https://www.thrivebureau.com/', button_type='url')
