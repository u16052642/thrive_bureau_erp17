...
from thrive import http, tools, _, release
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/thrive_ui_icons', type='http', auth='none', cors="*")
    def thrive_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/thrive_ui_icons/fonts/thrive_ui_icons.woff2').get_response()
