...
from thrive.addons.im_livechat.tests.common import TestImLivechatCommon
...
class TestGetDiscussChannel(TestImLivechatCommon):
    ...
    def test_channel_get_livechat_visitor_info(self):
        ...
        with patch('thrive.http.GeoIP.country_code', new_callable=PropertyMock(return_value=belgium.code)):
