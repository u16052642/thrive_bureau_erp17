...
class User(models.Model):
    ...
    def _sync_single_event(self, calendar_service: GoogleCalendarService, thrive_event, event_id):
        self.ensure_one()
        ...
        synced_events = self.env['calendar.event']._sync_google2thrive(event, default_reminders=default_reminders)
        # Thrive -> Google
        thrive_event.with_context(send_updates=send_updates)._sync_thrive2google(calendar_service)
        return bool(thrive_event | synced_events)
