...
from thrive.addons import __path__ as __addons_path__
...
class TestImportModule(thrive.tests.TransactionCase):
    ...
    def test_import_zip_invalid_manifest(self):
        ...
        with mute_logger("thrive.addons.base_import_module.models.ir_module"):
    ...
    def test_import_zip_ignore_unexpected_data_extension(self):
        ...
        with self.assertLogs('thrive.addons.base_import_module.models.ir_module') as log_catcher:
            self.import_zipfile(files)
...
class TestImportModuleHttp(TestImportModule, thrive.tests.HttpCase):
