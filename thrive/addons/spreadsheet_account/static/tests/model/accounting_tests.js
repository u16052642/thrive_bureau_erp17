...
QUnit.module("spreadsheet_account > Accounting", { beforeEach }, () => {
    ...
    QUnit.test("Evaluation with multiple account codes", async (assert) => {
        ...
        // with spaces
        setCellContent(model, "B1", `=THRIVE.CREDIT("100 , 200", "2022")`);
        setCellContent(model, "B2", `=THRIVE.DEBIT("100 , 200", "2022")`);
        setCellContent(model, "B3", `=THRIVE.BALANCE("100 , 200", "2022")`);
