...
export class CommonThriveChartConfigPanel extends Component {
     ...
     */
    refresh() {
        this.env.model.dispatch("REFRESH_THRIVE_CHART", { chartId: this.props.figureId });
    }
...
CommonThriveChartConfigPanel.components = { IrMenuSelector, DomainSelector };
CommonThriveChartConfigPanel.props = {
    figureId: String,
    definition: Object,
