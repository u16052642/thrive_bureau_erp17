...
import { Component, useState, useExternalListener, useRef, onMounted } from "@thrive/owl";
...
export class IrMenuSelectorDialog extends Component {
    setup() {
        ...
        useExternalListener(document.body, "click", (ev) => {
            ev.stopPropagation();
            ev.preventDefault(); // stop jumping to thrive home page
        });
    }
    _onConfirm() {
...
IrMenuSelectorDialog.title = _t("Select an Thrive menu to link in your spreadsheet");
