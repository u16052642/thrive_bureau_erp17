...
import { Component, useRef, useSubEnv } from "@thrive/owl";
 ...
 * It uses a feature to automatically create links to other thrive pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
