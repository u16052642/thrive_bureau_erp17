...
function documentationItem(env) {
    const documentationURL = "https://www.thrivebureau.com/documentation/17.0";
    return {
        type: "item",
        id: "documentation",
...
function thriveAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My thrivebureau.com account"),
        callback: () => {
            env.services
                ...
                .catch(() => {
                    browser.open("https://accounts.thrivebureau.com/account", "_blank");
                });
        },
        sequence: 60,
    };
