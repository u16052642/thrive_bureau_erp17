...
QUnit.module("utils", () => {
    ...
    QUnit.test("escape", (assert) => {
        ...
        assert.strictEqual(
            escape(`<a href="https://www.thrivebureau.com">thrive<a>`),
            `&lt;a href=&quot;https://www.thrivebureau.com&quot;&gt;thrive&lt;a&gt;`
        );
        assert.strictEqual(
            escape(`<a href='https://www.thrivebureau.com'>thrive<a>`),
            `&lt;a href=&#x27;https://www.thrivebureau.com&#x27;&gt;thrive&lt;a&gt;`
        ...
        assert.strictEqual(
            escape("<a href='https://www.thrivebureau.com'>Thrive`s website<a>"),
            `&lt;a href=&#x27;https://www.thrivebureau.com&#x27;&gt;Thrive&#x60;s website&lt;a&gt;`
        );
    });
    ...
    QUnit.test("isEmail", (assert) => {
        ...
        assert.notOk(isEmail("test@thrive"));
        assert.notOk(isEmail("test@thrive@thrivebureau.com"));
        assert.notOk(isEmail("te st@thrivebureau.com"));

        assert.ok(isEmail("test@thrivebureau.com"));
    });
});
