# Part of Thrive Bureau ERP. See LICENSE file for full copyright and licensing details.
{
    ...
    'website': 'https://www.thrivebureau.com/documentation/17.0/applications/finance/fiscal_localizations/luxembourg.html',
...
""",
    'author': 'Thrive Bureau ERP, ADN, ACSONE SA/NV',
    'depends': [
        'account',
        'base_iban',
        'base_vat',
