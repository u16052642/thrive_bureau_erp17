...
import { useSubEnv, status, markup } from "@thrive/owl";
...
export class MassMailingHtmlField extends HtmlField {
    ...
    async commitChanges() {
        ...
        this._pendingCommitChanges = (async () => {
            ...
            this.wysiwyg.thriveEditor.historyPauseSteps();
            ...
            this.wysiwyg.thriveEditor.historyUnpauseSteps();
            this.wysiwyg.thriveEditor.historyRevertCurrentStep();
    ...
    async _onSnippetsLoaded() {
        ...
        $snippetsSideBar.on('click', '.o_codeview_btn', () => {
            ...
            if ($codeview.hasClass('d-none')) {
                ...
                this.wysiwyg.thriveEditor.sanitize();
    ...
    async _lazyloadWysiwyg() {
        ...
        const wysiwygModule = await thrive.loader.modules.get('@mass_mailing/js/mass_mailing_wysiwyg');
