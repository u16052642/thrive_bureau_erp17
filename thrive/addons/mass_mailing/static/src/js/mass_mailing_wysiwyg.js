...
import { closestElement } from "@web_editor/js/editor/thrive-editor/src/ThriveEditor";
...
export class MassMailingWysiwyg extends Wysiwyg {
    ...
    async setSnippetsMenuFolded(fold = true) {
        if (fold) {
            ...
            if (!this.floatingToolbar) {
                ...
                this.thriveEditor.setupToolbar(this.toolbarEl);
    ...
    async _createSnippetsMenuInstance(options={}) {
        ...
        const { MassMailingSnippetsMenu }  = await thrive.loader.modules.get('@mass_mailing/js/snippets.editor');
