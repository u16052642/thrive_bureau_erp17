...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.emails_provider_generic = {
            ...
            ('fp@thrivebureau.com', 'fp@thrivebureau.com'),
            ('fp.alias@mail.thrivebureau.com', 'fp.alias@mail.thrivebureau.com'),
        }
        cls.emails_provider_company = {
            ('robert.poilvert@mycompany.com', 'mycompany.com'),
            ('fp@subdomain.thrivebureau.com', 'subdomain.thrivebureau.com'),
        }
        ...
        cls.lead_generic = cls.env['crm.lead'].create({
            'country_id': country_us_id,
            'email_from': 'FP@thrivebureau.com',
            'name': 'Generic 1',
            'mobile': False,
        ...
        cls.lead_generic_email_dupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': '"Fabulous Fab" <fp@THRIVE.COM>',
                'name': 'Dupe1 of fp@thrivebureau.com (same email)',
                'type': 'lead',
            },
            {
                'email_from': 'FP@thrivebureau.com',
                'name': 'Dupe2 of fp@thrivebureau.com (same email)',
                'type': 'lead',
            },
            # phone_sanitized based
            {
                'email_from': 'not.fp@not.thrivebureau.com',
                'name': 'Dupe3 of fp@thrivebureau.com (same phone sanitized)',
                'phone': '+1 202 555 0123',
                'type': 'lead',
            },
            {
                ...
                'name': 'Dupe4 of fp@thrivebureau.com (same phone sanitized)',
                'type': 'lead',
            },
            # same commercial entity
            {
                'name': 'Dupe5 of fp@thrivebureau.com (same commercial entity)',
                'partner_id': cls.test_partners[1].id,
            },
            {
                'name': 'Dupe6 of fp@thrivebureau.com (same commercial entity)',
        ...
        cls.lead_generic_email_notdupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': 'not.fp@thrivebureau.com',
                'name': 'NotADupe1',
                'type': 'lead',
            },
        ])
    ...
    def test_assert_initial_values(self):
        ...
        self.assertEqual(lead_generic.email_domain_criterion, 'fp@thrivebureau.com')
        self.assertEqual(lead_generic.email_normalized, 'fp@thrivebureau.com')
