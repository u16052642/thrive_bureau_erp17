...
from thrive.addons.account.tests.test_account_move_send import TestAccountMoveSendCommon
...
class TestUBLBE(TestUBLCommon, TestAccountMoveSendCommon):
    ...
    def test_export_import_invoice(self):
        ...
        attachment = self._assert_invoice_attachment(
            ...
            ''',
            expected_file_path='from_thrive/bis3_out_invoice.xml',
        )
    ...
    def test_export_import_refund(self):
        ...
        attachment = self._assert_invoice_attachment(
            ...
            ''',
            expected_file_path='from_thrive/bis3_out_refund.xml',
        )
        self.assertEqual(attachment.name[-12:], "ubl_bis3.xml")
    ...
    def test_sending_to_public_admin(self):
        ...
        self._assert_invoice_attachment(
            ...
            ''',
            expected_file_path='from_thrive/bis3_out_invoice_public_admin.xml',
        )
    ...
    def test_rounding_price_unit(self):
        ...
        * Invoice line net amount shall be rounded to two decimals
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_thrive/bis3_out_invoice_rounding.xml')
    ...
    def test_export_with_fixed_taxes_case1(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_thrive/bis3_ecotaxes_case1.xml')
    ...
    def test_export_with_fixed_taxes_case2(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_thrive/bis3_ecotaxes_case2.xml')
    ...
    def test_export_with_fixed_taxes_case3(self):
        ...
        self.assertEqual(invoice.amount_total, 121)
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_thrive/bis3_ecotaxes_case3.xml')
    ...
    def test_export_payment_terms(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_thrive/bis3_pay_term.xml')
    ...
    def test_export_payment_terms_fixed_tax(self):
        ...
        self._assert_invoice_attachment(invoice.ubl_cii_xml_id, None, 'from_thrive/bis3_pay_term_ecotax.xml')
    ...
    def test_import_payment_terms(self):
        ...
        self._assert_imported_invoice_from_file(
            subfolder='tests/test_files/from_thrive', filename='bis3_pay_term.xml', amount_total=3105.68,
