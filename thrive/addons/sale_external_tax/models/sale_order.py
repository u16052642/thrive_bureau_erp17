...
class SaleOrder(models.Model):
    ...
    def _compute_tax_totals(self):
        ...
        returns, not the values thrivebureau.computes. This will create a
    ...
    def _compute_amounts(self):
        ...
        service returns, not the values thrivebureau.computes.
        """
...
class SaleOrderLine(models.Model):
    ...
    def _prepare_invoice_line(self, **optional_values):
        """ Override to clear tax_ids on lines. Brazilian taxes are variable and don't have the right amount set in Thrive (always 1%),
