# Part of Thrive Bureau ERP. See LICENSE file for full copyright and licensing details.
{
    ...
    'website': 'https://www.thrivebureau.com/documentation/17.0/applications/finance/fiscal_localizations/brazil.html',
...
configure Thrive in order to properly use Avatax and send the needed fiscal
