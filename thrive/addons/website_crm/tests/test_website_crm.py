...
class TestWebsiteCrm(thrive.tests.HttpCase):
    ...
    def test_tour(self):
        ...
        self.assertEqual(record.partner_name, 'Thrive Bureau ERP')
    ...
    def test_catch_logged_partner_info_tour(self):
        ...
        with thrive.tests.RecordCapturer(self.env['crm.lead'], []) as capt:
