...
from thrive import _lt, _

PROXY_ERROR_CODES = {
    "error_codabox_not_configured": _lt("Codabox is not configured. Please check your configuration."),
    "error_connecting_iap": _lt("Error while connecting to the IAP server. Please contact Thrive support."),
    ...
    "error_fidu_registered_invalid_iap_token": _lt("The provided access token is not valid for this fiduciary. Please check your configuration.\nIf you have lost your access token, please contact Thrive support."),
    "error_connecting_codabox": _lt("Error while connecting to Codabox. Please contact Thrive support."),
...
DEFAULT_IAP_ENDPOINT = "https://l10n-be-codabox.api.thrivebureau.com/api/l10n_be_codabox/1"
...
def get_error_msg(error):
    ...
    if error_type == 'error_connecting_codabox' and codabox_error_code:
        return CODABOX_ERROR_CODES.get(codabox_error_code, _("Unknown error %s while contacting Codabox. Please contact Thrive support.", codabox_error_code))
    return PROXY_ERROR_CODES.get(error_type, _("Unknown error %s while contacting Codabox. Please contact Thrive support.", error_type))
