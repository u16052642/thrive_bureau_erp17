...
from thrive.tools.misc import file_path
...
class TestAddonPaths(TransactionCase):
    def test_operations(self):
        ...
        asset_paths.append([
            ('/home/user/thrive/addons/web/a', '/web/a', 1),
            ('/home/user/thrive/addons/web/c', '/web/c', 1),
            ('/home/user/thrive/addons/web/d', '/web/d', 1),
        ], 'bundle1')
        self.assertEqual(asset_paths.list, [
            ('/home/user/thrive/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/thrive/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/thrive/addons/web/d', '/web/d', 'bundle1', 1),
        ])

        # append with a duplicate of 'c'
        asset_paths.append([
            ('/home/user/thrive/addons/web/c', '/web/c', 1),
            ('/home/user/thrive/addons/web/f', '/web/f', 1),
        ], 'bundle2')
        self.assertEqual(asset_paths.list, [
            ('/home/user/thrive/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/thrive/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/thrive/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/thrive/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'c' after 'c'
        asset_paths.insert([
            ('/home/user/thrive/addons/web/c', '/web/c', 1),
            ('/home/user/thrive/addons/web/e', '/web/e', 1),
        ], 'bundle3', 3)
        self.assertEqual(asset_paths.list, [
            ('/home/user/thrive/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/thrive/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/thrive/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/thrive/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/thrive/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'd' before 'd'
        asset_paths.insert([
            ('/home/user/thrive/addons/web/b', '/web/b', 1),
            ('/home/user/thrive/addons/web/d', '/web/d', 1),
        ], 'bundle4', 1)
        self.assertEqual(asset_paths.list, [

            ('/home/user/thrive/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/thrive/addons/web/b', '/web/b', 'bundle4', 1),
            ('/home/user/thrive/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/thrive/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/thrive/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/thrive/addons/web/f', '/web/f', 'bundle2', 1),
        ...
        asset_paths.remove([
            ('/home/user/thrive/addons/web/c', '/web/c', 1),
            ('/home/user/thrive/addons/web/d', '/web/d', 1),
            ('/home/user/thrive/addons/web/g', '/web/g', 1),
        ], 'bundle5')
        self.assertEqual(asset_paths.list, [
            ('/home/user/thrive/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/thrive/addons/web/b', '/web/b', 'bundle4', 1),
...
<html>
    <head>
        ...
        <script type="text/javascript" src="{links[5]}" onerror="__thriveAssetError=1"></script>
    </head>
    <body>
    </body>
</html>"""))
...
<html>
    <head>
        ...
        <script type="text/javascript" src="http://test.external.link/javascript1.js"></script>
        <script type="text/javascript" src="http://test.external.link/javascript2.js"></script>
        <script type="text/javascript" src="/web/assets/debug/test_assetsbundle.bundle4.js" onerror="__thriveAssetError=1"></script>
    </head>
    <body>
    </body>
</html>"""))
