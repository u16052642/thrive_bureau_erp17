...
from thrive import _, api, fields, models, modules, tools
...
from thrive.addons.account_edi_ubl_cii.models.account_edi_common import EAS_MAPPING
...
class ResConfigSettings(models.TransientModel):
    ...
    def button_create_peppol_proxy_user(self):
        ...
        # but we need the field for future in case the user decided to migrate away from Thrive Bureau ERP
