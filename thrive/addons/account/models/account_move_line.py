...
from thrive.tools import frozendict, format_date, float_compare, Query
from thrive.tools.sql import create_index, SQL
from thrive.addons.web.controllers.utils import clean_action

from thrive.addons.account.models.account_move import MAX_HASH_VERSION
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_move_line_residual_amounts(self, aml_values, counterpart_currency, shadowed_aml_values=None, other_aml_values=None):
        ...
        def get_thrive_rate(aml, other_aml, currency):
        ...
        if currency == company_currency \
            ...
            rate = get_thrive_rate(aml, other_aml, counterpart_currency)
