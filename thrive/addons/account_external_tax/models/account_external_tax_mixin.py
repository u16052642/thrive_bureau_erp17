...
from thrive import models, fields, api, registry, SUPERUSER_ID
...
class AccountExternalTaxMixin(models.AbstractModel):
    ...
    is_tax_computed_externally = fields.Boolean(
        ...
        help='Technical field to determine if tax is calculated using an external service instead of Thrive.'
    )
