...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        old_action_post = thrive.addons.account.models.account_move.AccountMove.action_post
        old_create = thrive.models.BaseModel.create
        ...
        post_patch = patch('thrive.addons.account.models.account_move.AccountMove.action_post', new_action_post)
        create_patch = patch('thrive.models.BaseModel.create', new_create)
