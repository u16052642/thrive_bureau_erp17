...
def load_certificate():
    ...
    try:
        ...
        _logger.exception("An error occurred while trying to reach thrivebureau.com servers.")
...
def download_from_url(download_url, path_to_filename):
    ...
    (Example: 'C:\\Program Files\\Thrive\\downloaded_file.zip')
    """
    try:
...
def unzip_file(path_to_filename, path_to_extract):
    ...
    Example: unzip_file('C:\\Program Files\\Thrive\\downloaded_file.zip', 'C:\\Program Files\\Thrive\\new_folder'))
