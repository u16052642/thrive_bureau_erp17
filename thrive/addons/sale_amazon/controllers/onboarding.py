...
from thrive.tools import hmac as hmac_tool
...
def compute_oauth_signature(account_id):
    ...
    :param thrive.api.Environment env: The current environment.
...
class AmazonController(http.Controller):
    ...
    def amazon_return_from_authorization(self, **data):
        ...
        # Retrieve the Amazon data and Thrive metadata from the redirect data.
