...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Script for testing the install / uninstall / reinstall"
                    " cycle of Thrive modules. Prefer the 'cycle' subcommand to"
...
if __name__ == '__main__':
    ...
    logging.config.dictConfig({
        ...
        'loggers': {
            'thrive.modules.loading': {'level': 'CRITICAL'},
            'thrive.sql_db': {'level': 'CRITICAL'},
            'thrive.models.unlink': {'level': 'WARNING'},
            'thrive.addons.base.models.ir_model': {'level': "WARNING"},
        }
    })
