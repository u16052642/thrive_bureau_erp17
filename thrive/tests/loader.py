...
from .suite import ThriveSuite
from .result import ThriveTestResult
...
def _get_upgrade_test_modules(module):
    upgrade_modules = (
        f"thrive.upgrade.{module}",
        f"thrive.addons.{module}.migrations",
        f"thrive.addons.{module}.upgrades",
    )
